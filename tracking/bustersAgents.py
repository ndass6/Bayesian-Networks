...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        minPos = legal[0]
        minDistance = self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, minPos), currPos)
        for a in legal:
            if self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, a), currPos) < minDistance:
                minDistance = self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, a), currPos)
                minPos = a
